...
class ShaverUnit extends StatefulWidget {
  const ShaverUnit({super.key});

  @override
  State<ShaverUnit> createState() => _ShaverUnitState();
}

class _ShaverUnitState extends State<ShaverUnit> {
...
final List<String> departments = [
  ...
  final ShaverController controller = ShaverController();
  int? _sortColumnIndex;
  bool _isAscending = true;

  Future<void> fetchData() async {
    try {
      await controller.fetchSaver();
      setState(() {});
    } catch (e) {
      print(e.toString());
    }
  ...
  void _sort<T>(Comparable<T> Function(ProductModel) getField, int columnIndex,
      bool ascending) {
    controller.shaverData.sort((a, b) {
...
void clearFields(){
                    ...
                    return null;
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Consumer<ShaverController>(builder: (context, value, child) {
                            return  InkWell(
                              onTap: () {
                              sendData();
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: DataTable(
                              ...
                              rows: controller.shaverData.map((purchase) {
  ...
  Future<void> sendData() async {
    if (_formKey.currentState!.validate()) {
      ...
      await Provider.of<ShaverController>(context, listen: false).sendTostore(
          itemCode.text,
          itemName.text,
          deliveryPerson.text,
          dateReceived!,
