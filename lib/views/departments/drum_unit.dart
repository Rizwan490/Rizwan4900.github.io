...
class DrumUnit extends StatefulWidget {
  const DrumUnit({super.key});

  @override
  State<DrumUnit> createState() => _DrumUnitState();
}

class _DrumUnitState extends State<DrumUnit> {
...
final List<String> departments = [
  ...
  final DrumController controller = DrumController();
  int? _sortColumnIndex;
  bool _isAscending = true;

  Future<void> fetchData() async {
    try {
      await controller.fetchDrum();
      setState(() {});
    } catch (e) {
      print(e.toString());
    }
...
void clearFields(){
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: DataTable(
                              ...
                              rows: controller.drumData.map((purchase) {
  ...
  Future<void> sendData() async {
    if (_formKey.currentState!.validate()) {
      ...
      await Provider.of<DrumController>(context, listen: false).sendTostore(
          itemCode.text,
          itemName.text,
          deliveryPerson.text,
          dateReceived!,
