...
class CuttingUnit extends StatefulWidget {
  const CuttingUnit({super.key});

  @override
  State<CuttingUnit> createState() => _CuttingUnitState();
}

class _CuttingUnitState extends State<CuttingUnit> {
...
final List<String> departments = [
  ...
  final CuttingController controller = CuttingController();
  int? _sortColumnIndex;
  bool _isAscending = true;

  Future<void> fetchData() async {
    try {
      await controller.fetchCutting();
      setState(() {});
    } catch (e) {
      print(e.toString());
    }
  ...
  void _sort<T>(Comparable<T> Function(ProductModel) getField, int columnIndex,
      bool ascending) {
    controller.cuttingData.sort((a, b) {
...
void clearFields(){
                    ...
                    return null;
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Consumer<StoreController>(builder: (context, value, child) {
                            return  InkWell(
                              onTap: () {
                              sendData();
                      ...
                      controller.cuttingData.isEmpty?
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: DataTable(
                              ...
                              rows: controller.cuttingData.map((purchase) {
  ...
  Future<void> sendData() async {
    if (_formKey.currentState!.validate()) {
      ...
      await Provider.of<CuttingController>(context, listen: false).sendTostore(
          itemCode.text,
          itemName.text,
          deliveryPerson.text,
          dateReceived!,
