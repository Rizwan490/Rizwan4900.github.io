...
class BuffUnit extends StatefulWidget {
  const BuffUnit({super.key});

  @override
  State<BuffUnit> createState() => _BuffUnitState();
}

class _BuffUnitState extends State<BuffUnit> {
TextEditingController itemCode = TextEditingController();
  ...
  final BuffController controller = BuffController();
                  ...
                  return null;
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Consumer<BuffController>(builder: (context, value, child) {
                          return  InkWell(
                            onTap: () {
                            sendData();
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: DataTable(
                            ...
                            rows: controller.buffData.map((purchase) {
  ...
  Future<void> sendData() async {
    if (_formKey.currentState!.validate()) {
      ...
      await Provider.of<BuffController>(context, listen: false).sendTostore(
          itemCode.text,
          itemName.text,
          deliveryPerson.text,
          dateReceived!,
