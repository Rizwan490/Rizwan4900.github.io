...
class StitchingUnit extends StatefulWidget {
  const StitchingUnit({super.key});

  @override
  State<StitchingUnit> createState() => _StitchingUnitState();
}

class _StitchingUnitState extends State<StitchingUnit> {
...
final List<String> departments = [
  ...
  final StitchingController controller = StitchingController();
  int? _sortColumnIndex;
  bool _isAscending = true;

  Future<void> fetchData() async {
    try {
      await controller.fetchStitching();
      setState(() {});
    } catch (e) {
      print(e.toString());
    }
  ...
  void _sort<T>(Comparable<T> Function(ProductModel) getField, int columnIndex,
      bool ascending) {
    controller.stitchingData.sort((a, b) {
...
void clearFields(){
                    ...
                    return null;
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Consumer<StitchingController>(builder: (context, value, child) {
                            return  InkWell(
                              onTap: () {
                              sendData();
                      ...
                      controller.stitchingData.isEmpty?
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: DataTable(
                              ...
                              rows: controller.stitchingData.map((purchase) {
  ...
  Future<void> sendData() async {
    if (_formKey.currentState!.validate()) {
      ...
      await Provider.of<StitchingController>(context, listen: false).sendTostore(
          itemCode.text,
          itemName.text,
          deliveryPerson.text,
          dateReceived!,
